    ...
    <div class="container">
        ...
        <div class="news-events-list">
            <div class="single-news-event">
                <figure>
                    <img src="{{ asset('front/assets/images/news-event/news-event-01.jpg') }}" alt="News & Event" />
                </figure>
            ...
            <div class="single-news-event">
                <figure>
                    <img src="{{ asset('front/assets/images/news-event/news-event-02.jpg') }}" alt="News & Event" />
                </figure>
                <div class="content-block">
                    <div class="member-info">
                        <div class="content_meta_category">
            ...
            <div class="single-news-event">
                <figure>
                    <img src="{{ asset('front/assets/images/news-event/news-event-03.jpg') }}" alt="News & Event" />
                </figure>
                <div class="content-block">
                    <div class="member-info">
                        <div class="content_meta_category">
