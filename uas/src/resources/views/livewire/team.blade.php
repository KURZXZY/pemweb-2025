    ...
    <div class="container">
        ...
        <div class="team-list">
            <div class="team-member">
                <figure>
                    <img src="{{ asset('front/assets/images/team-img-01.jpg') }}" alt="team" />
                </figure>
            ...
            <div class="team-member">
                <figure>
                    <img src="{{ asset('front/assets/images/team-img-02.jpg') }}" alt="team" />
                </figure>
                <div class="content-block">
                    <div class="member-info">
            ...
            <div class="team-member">
                <figure>
                    <img src="{{ asset('front/assets/images/team-img-03.jpg') }}" alt="team" />
                </figure>
                <div class="content-block">
                    <div class="member-info">
                        <h4>Anna Delpan</h4>
